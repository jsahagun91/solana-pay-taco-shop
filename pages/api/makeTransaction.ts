...
function get(res: NextApiResponse<MakeTransactionGetResponse>) {
    res.status(200).json({
        label: "Asu Madre Tacos!",
        icon: "https://freesvg.org/img/taco.png"
    })
}
...
async function post(
    ...
    try {
        ...
        // If the shop is sendinh a coupon, it already will be a signer
        ...
        // Sign the transaction as the shop, which is required to trasnfer coupon
